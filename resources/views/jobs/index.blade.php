        ...
        <div class="max-w-7xl mx-auto">
            <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="flex flex-wrap gap-4 md:items-center">
                    <form method="POST" action="{{ route('jobs.sync') }}" class="shrink-0">
                        @csrf
                        <button type="submit" class="whitespace-nowrap shrink-0 min-w-max bg-white border-2 border-[#4f46e5] text-[#4f46e5] px-4 py-2 rounded-xl font-bold shadow-sm hover:bg-indigo-50 flex items-center h-[42px] transition-all">
